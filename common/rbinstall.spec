...
Requires:       rbenv libyaml ca-certificates zlib
...
%changelog
* Tue May 12 2026 Anton Novojilov <andy@essentialkaos.com> - 3.6.1-0
- Dependencies update

* Thu May 07 2026 Anton Novojilov <andy@essentialkaos.com> - 3.6.0-0
- Migrated to ek.v14
- Dependencies update

* Wed Dec 17 2025 Anton Novojilov <andy@essentialkaos.com> - 3.5.3-0
- Dependencies update

* Tue Oct 28 2025 Anton Novojilov <andy@essentialkaos.com> - 3.5.2-0
- Code refactoring
- Dependencies update

* Sun Apr 13 2025 Anton Novojilov <andy@essentialkaos.com> - 3.5.1-0
- Code refactoring
- Dependencies update

* Fri Aug 02 2024 Anton Novojilov <andy@essentialkaos.com> - 3.5.0-0
...
* Wed Mar 20 2024 Anton Novojilov <andy@essentialkaos.com> - 3.4.2-0
- [cli|gen|clone] Improved support information gathering
- Dependencies update

* Wed Jan 24 2024 Anton Novojilov <andy@essentialkaos.com> - 3.4.1-0
- Dependencies update
